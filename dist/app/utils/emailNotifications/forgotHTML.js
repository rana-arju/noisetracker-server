...
exports.forgotEmailTemplate = void 0;
const forgotEmailTemplate = (otp) => `<!DOCTYPE html>
<html lang="en" style="margin: 0; padding: 0;">

<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>luckyteeguarden - Password Reset Code</title>
    <style>
        :root {
...
<body>
    <div class="email-wrapper">
        <table role="presentation" class="email-container" align="center">
            ...
            <tr>
                <td class="header">
                    <h2 class="company-name">luckyteeguarden</h2>
                </td>
            </tr>
